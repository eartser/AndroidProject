package com.elizavetaartser.androidproject.di.module
...
import com.elizavetaartser.androidproject.data.network.interceptor.AndroidProjectAuthenticator
import com.elizavetaartser.androidproject.data.network.interceptor.AuthorizationInterceptor
import com.elizavetaartser.androidproject.interactor.UserAgentInterceptor
    ...
    fun provideOkhttpClient(authRepository: AuthRepository): OkHttpClient =
        OkHttpClient.Builder()
            .apply {
                ...
                authenticator(AndroidProjectAuthenticator(authRepository))
